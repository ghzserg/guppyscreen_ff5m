  ...
  , always_visible(false)
{
  ...
  lv_obj_add_event_cb(hide_show_cont, &MacroItem::_handle_hide_show, LV_EVENT_SHORT_CLICKED, this);
  ...
  lv_obj_set_style_text_font(run_btn, &notosemi_16, LV_STATE_DEFAULT);
  ...
  lv_obj_add_event_cb(run_btn , &MacroItem::_handle_send_macro, LV_EVENT_SHORT_CLICKED, this);
